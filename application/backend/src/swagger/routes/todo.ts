...
import { RESPONSE_200, RESPONSE_404, SCHEMA } from 'src/swagger/util/constants';
import { USER_ID_PATH_REQ } from './user';
...
const ITEM_ID_PATH_REQ: ISwaggerParametersRequest = {
  in: 'path',
  name: 'id',
  style: 'simple',
  description: 'Item id',
